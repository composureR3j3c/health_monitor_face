  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex items-center gap-6">
        <a href="#apis" className="hover:text-blue-500 transition">APIs</a>
        <a href="#metrics" className="hover:text-blue-500 transition">Metrics</a>
        <a href="#logs" className="hover:text-blue-500 transition">Logs</a>
        <a href="#settings" className="hover:text-blue-500 transition">Settings</a>
      </div>
      ...
      {menuOpen && (
        ...
        >
          <a href="#apis" onClick={() => setMenuOpen(false)}>APIs</a>
          <a href="#metrics" onClick={() => setMenuOpen(false)}>Metrics</a>
          <a href="#logs" onClick={() => setMenuOpen(false)}>Logs</a>
